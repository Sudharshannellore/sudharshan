          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            ...
            >
              ...
              <ArrowRight size={20} />
                ...
                <a href="https://drive.google.com/file/d/1o6Pw6GOoen6sXcHuDCjAVAXzUFzJUutm/view?usp=sharing" target='_blank' className="inline-flex items-center gap-2 px-6 py-3 border border-white rounded-full hover:bg-white hover:text-black transition">
                    Download Resume
                </a>
          </div>
        </div>
